...
async function safePublish(
  ...
  if (!check.ok) {
    console.warn(`[prizma] payload inválido para "${eventType}", no se publica:`, check.error);
    return false;
  }
...
/**
 * delivery.created — una entrega quedó registrada en Talaria.
...
/**
 * Traduce los estados internos de Talaria (orderState en español) al enum
 * que define `prizma-contracts` para delivery.status_update.
 */
