...
export const SelectPosition = () => {
  ...
  const geolocationDeliveryJson = useMemo(() => JSON.parse(orderByDeliveryNumber?.geolocationDelivery || null), [orderByDeliveryNumber.geolocationDelivery]);
  ...
  }, [orderByDeliveryNumber.geolocationDelivery]);
